...
const TodoCard = ({elem,todos,setTodos}) => {
  ...
  return (
    <div className='flex justify-between gap-8  border border-gray-300 rounded-lg md:py-3 md:px-6 py-1 px-3 items-center'>
      ...
      <div className='flex justify-between gap-2 md:gap-8 md:px-4 items-center '>
        <button className='border border-purple-600 bg-purple-50 flex items-center  md:gap-2 py-1 px-2 md:px-4 md:py-2 rounded text-purple-600 font-medium text-sm'><MdOutlineEdit /> <span className='hidden md:block md:text-lg'>Edit</span></button>
